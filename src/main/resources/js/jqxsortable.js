    ...
    a.extend(a.jqx._jqxSortable.prototype, {
        defineInstance: function () {
            var b = {
                ...
                _events: ["activate", "beforeStop", "change", "deactivate", "out", "over", "receive", "removeItem", "sort", "start", "stop", "update", "create"]
            };
            ...
            var c = this.css("position"), b = c === "absolute", e = d ? /(auto|scroll|hidden)/ : /(auto|scroll)/,
            ...
            e.offset = {top: e.offset.top - e.margins.top, left: e.offset.left - e.margins.left};
            a.extend(e.offset, {
                click: {left: f.pageX - e.offset.left, top: f.pageY - e.offset.top},
            ...
            e.domPosition = {prev: e.currentItem.prev()[0], parent: e.currentItem.parent()[0]};
            ...
            if (c.revert) {
                var c = this, g = c.placeholder.offset(), b = c.axis, e = {};
                if (!b || b === "x") {
            ...
            var e = this.positionAbs.left, d = e + this.helperProportions.width, m = this.positionAbs.top,
                k = m + this.helperProportions.height, f = o.left, c = f + o.width, p = o.top, j = p + o.height,
                q = this.offset.click.top, i = this.offset.click.left,
                h = (this.axis === "x") || ((m + q) > p && (m + q) < j),
                n = (this.axis === "y") || ((e + i) > f && (e + i) < c), g = h && n;
            ...
            var e = (this.axis === "x") || this._isOverAxis(this.positionAbs.top + this.offset.click.top, d.top, d.height),
                ...
                g = e && c, b = this._getDragVerticalDirection(), f = this._getDragHorizontalDirection();
            if (!g) {
                return false
            }
            ...
            var d, c, k, f, g = [], e = [], h = this._connectWith();
            if (h && b) {
            ...
            this.itemsArray = [];
            this.owners = [this];
            var f, d, m, g, l, c, o, n, h = this.itemsArray,
                e = [[a.isFunction(this.items) ? this.items.call(this.host[0], b, {item: this.currentItem}) : a(this.items, this.host), this]],
                k = this._connectWith();
            if (k && this.ready) {
                for (f = k.length - 1; f >= 0; f--) {
                    ...
                    for (d = m.length - 1; d >= 0; d--) {
                        ...
                        if (g && g !== this && !g.instance.disabled) {
                            e.push([a.isFunction(g.instance.items) ? g.items.call(g.instance.host[0], b, {item: this.currentItem}) : a(g.instance.items, g.instance.host), g.instance]);
            ...
            for (f = e.length - 1; f >= 0; f--) {
                ...
                for (d = 0, n = c.length; d < n; d++) {
                    ...
                    h.push({item: o, instance: l, width: 0, height: 0, left: 0, top: 0})
                }
            }
        ...
        }, _contactOwners: function (b) {
            var g, e, n, h, k, p, q, f, l, d, c = null, o = null;
            ...
            b.scrollParent = function (g) {
                var f = this.css("position"), e = f === "absolute", h = g ? /(auto|scroll|hidden)/ : /(auto|scroll)/,
            ...
            var g, f, h = this, d = e.pageX, c = e.pageY,
                b = this.cssPosition === "absolute" && !(this.scrollParent[0] !== this.document[0] && a.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
