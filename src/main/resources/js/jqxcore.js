...
if (!oldBrowser) {
    (function (bd, G) {
        var q, an, ak = bd.document, bo = bd.location, bt = bd.navigator, ax = bd.JQXLite, X = bd.$,
            aR = Array.prototype.push, aD = Array.prototype.slice, aA = Array.prototype.indexOf,
            y = Object.prototype.toString, b = Object.prototype.hasOwnProperty, aw = String.prototype.trim,
            C = function (bu, bv) {
                return new C.fn.init(bu, bv, q)
            }, aE = /[\-+]?(?:\d*\.|)\d+(?:[eE][\-+]?\d+|)/.source, at = /\S/, a8 = /\s+/,
            S = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, aF = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
            e = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, j = /^[\],:{}\s]*$/, t = /(?:^|:|,)(?:\s*\[)+/g,
            a5 = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
            K = /"[^"\\\r\n]*"|true|false|null|-?(?:\d\d*\.|)\d+(?:[eE][\-+]?\d+|)/g, au = /^-ms-/, aS = /-([\da-z])/gi,
            m = function (bu, bv) {
        ...
        C.fn = C.prototype = {
            constructor: C, init: function (bu, bx, by) {
                var bw, bz, bv, bA;
                if (!bu) {
                    return this
                }
        ...
        C.extend({
            noConflict: function (bu) {
                ...
                return C
            }, isReady: false, readyWait: 1, holdReady: function (bu) {
                if (bu) {
                    C.readyWait++
                } else {
                    C.ready(true)
                ...
                var bu = bw.length, bx = by.length, bv = 0;
                if (typeof bu === "number") {
                    for (; bv < bu; bv++) {
                        by[bx++] = bw[bv]
                    }
                ...
                var bz, bA, by = [], bw = 0, bv = bu.length,
        ...
        C.extend({
            Deferred: function (bw) {
                ...
                var bw = 0, bA = aD.call(arguments), bu = bA.length,
                    bv = bu !== 1 || (by && C.isFunction(by.promise)) ? bu : 0, bD = bv === 1 ? by : C.Deferred(),
        ...
        C.support = (function () {
            ...
            bB.appendChild(bv);
            if (bv.attachEvent) {
                for (by in {submit: true, change: true, focusin: true}) {
                    bz = "on" + by;
                    bw = (bz in bv);
                    if (!bw) {
            ...
            C(function () {
                ...
                if (bd.getComputedStyle) {
                    ...
                    bG.boxSizingReliable = (bd.getComputedStyle(bM, null) || {width: "4px"}).width === "4px";
        ...
        C.extend({
            ...
            data: function (bx, bv, bz, by) {
                ...
                var bA, bC, bD = C.expando, bB = typeof bv === "string", bE = bx.nodeType, bu = bE ? C.cache : bx,
        ...
        C.extend({
            queue: function (bw, bv, bx) {
                ...
                by = by || "fx";
                var bv = C.queue(bz, by), bA = bv.length, bx = bv.shift(), bu = C._queueHooks(bz, by),
                    bw = function () {
                        C.dequeue(bz, by)
                    };
                if (bx === "inprogress") {
        ...
        var bh, aT, ay, aI = /[\t\r\n]/g, aP = /\r/g, d = /^(?:button|input)$/i,
            z = /^(?:button|input|object|select|textarea)$/i, h = /^a(?:rea|)$/i,
        ...
        C.fn.extend({
            attr: function (bu, bv) {
                ...
                var bw = typeof bx, bu = typeof bv === "boolean";
                if (C.isFunction(bx)) {
        ...
        C.extend({
            valHooks: {
                option: {
                    ...
                    get: function (bu) {
                        var bA, bw, bC = bu.options, by = bu.selectedIndex, bx = bu.type === "select-one" || by < 0,
                            bB = bx ? null : [], bz = bx ? by + 1 : bC.length, bv = by < 0 ? bz : bx ? by : 0;
                        for (; bv < bz; bv++) {
                            bw = bC[bv];
        ...
        var bf = /^(?:textarea|input|select)$/i, n = /^([^\.]*|)(?:\.(.+)|)$/, F = /(?:^|\s)hover(\.\S+|)\b/,
            aH = /^key/, bi = /^(?:mouse|contextmenu)|click/, N = /^(?:focusinfocus|focusoutblur)$/,
            bs = function (bu) {
        ...
        C.event = {
            ...
            dispatch: function (bu) {
                ...
                var bB, bA, bK, bE, bD, bv, bC, bI, bx, bJ, by = ((C._data(this, "events") || {})[bu.type] || []),
                    bz = by.delegateCount, bG = aD.call(arguments), bw = !bu.exclusive && !bu.namespace,
                    bF = C.event.special[bu.type] || {}, bH = [];
                bG[0] = bu;
                ...
                if (bz && !(bu.button && bu.type === "click")) {
                    for (bK = bu.target; bK != this; bK = bK.parentNode || this) {
                        if (bK.disabled !== true || bu.type !== "click") {
                            ...
                            if (bC.length) {
                                bH.push({elem: bK, matches: bC})
                            }
                        }
                    }
                }
                if (by.length > bz) {
                    bH.push({elem: this, matches: by.slice(bz)})
                }
            ...
            fixHooks: {},
            keyHooks: {
                props: "char charCode key keyCode".split(" "), filter: function (bv, bu) {
                    if (bv.which == null) {
            ...
            fix: function (bw) {
                ...
                var bv, bz, bu = bw, bx = C.event.fixHooks[bw.type] || {},
            ...
            simulate: function (bv, bx, bw, bu) {
                var by = C.extend(new C.Event(), bw, {type: bv, isSimulated: true, originalEvent: {}});
                if (bu) {
        ...
        C.Event.prototype = {
            ...
            }, isDefaultPrevented: bn, isPropagationStopped: bn, isImmediatePropagationStopped: bn
        };
        C.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (bv, bu) {
            C.event.special[bv] = {
                delegateType: bu, bindType: bu, handle: function (bz) {
        ...
        C.fn.extend({
            on: function (bw, bu, bz, by, bv) {
                ...
                var bv = arguments, bu = bx.guid || C.guid++, bw = 0, by = function (bz) {
         ...
         */
        (function (cn, bM) {
            var cs, bF, cg, bv, bR, b5, bI, bL, bH, ce, bE = true, bZ = "undefined",
                cu = ("sizcache" + Math.random()).replace(".", ""), bz = String, bD = cn.document,
                bG = bD.documentElement, bW = 0, bK = 0, b9 = [].pop, cr = [].push, bQ = [].slice,
                bT = [].indexOf || function (cE) {
                    var cD = 0, cC = this.length;
                    for (; cD < cC; cD++) {
                        if (this[cD] === cE) {
                            return cD
                        }
                ...
                bN = bP.replace("w", "w#"), cz = "([*^$|!~]?=)",
                ck = "\\[" + b3 + "*(" + bP + ")" + b3 + "*(?:" + cz + b3 + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + bN + ")|)|)" + b3 + "*\\]",
                cB = ":(" + bP + ")(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:" + ck + ")|[^:]|\\\\.)*|.*))\\)|)",
                b4 = ":(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + b3 + "*((?:-\\d)?\\d*)" + b3 + "*\\)|)(?=[^-]|$)",
                co = new RegExp("^" + b3 + "+|((?:^|[^\\\\])(?:\\\\.)*)" + b3 + "+$", "g"),
                bA = new RegExp("^" + b3 + "*," + b3 + "*"),
                cc = new RegExp("^" + b3 + "*([\\x20\\t\\r\\n\\f>+~])" + b3 + "*"), ch = new RegExp(cB),
                cj = /^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/, b8 = /^:not/, cm = /[\x20\t\r\n\f]*[+~]/, cv = /:not\($/,
                bX = /h\d/i, ci = /input|select|textarea|button/i, bY = /\\(?!\\)/g, cb = {
                    ID: new RegExp("^#(" + bP + ")"),
                    CLASS: new RegExp("^\\.(" + bP + ")"),
            ...
            b5 = cl.contains = bG.contains ? function (cD, cC) {
                var cF = cD.nodeType === 9 ? cD.documentElement : cD, cE = cC && cC.parentNode;
            ...
            cg = cl.selectors = {
                ...
                pseudos: {
                    not: cw(function (cC) {
                        var cD = [], cE = [], cF = bI(cC.replace(co, "$1"));
            ...
            function b1(cG, cE, cF) {
                var cC = cE.dir, cH = cF && cE.dir === "parentNode", cD = bK++;
            ...
            function cx(cE, cD, cG, cF, cH, cC) {
                ...
                return cw(function (cS, cP, cK, cR) {
                    var cU, cQ, cM, cL = [], cT = [], cJ = cP.length,
            ...
            function b2(cI) {
                var cD, cG, cE, cH = cI.length, cL = cg.relative[cI[0].type], cM = cL || cg.relative[" "],
                    cF = cL ? 1 : 0, cJ = b1(function (cN) {
                        return cN === cD
            ...
            function bB(cF, cE) {
                var cC = cE.length > 0, cG = cF.length > 0, cD = function (cQ, cK, cP, cO, cW) {
                    var cL, cM, cR, cV = [], cU = 0, cN = "0", cH = cQ && [], cS = cW != null, cT = ce,
        ...
        var U = /Until$/, ag = /^(?:parents|prev(?:Until|All))/, bq = /^.[^:#\[\.,]*$/, aQ = C.expr.match.needsContext,
            ao = {children: true, contents: true, next: true, prev: true};
        C.fn.extend({
            find: function (bu) {
        ...
        function a(bu) {
            var bw = aJ.split("|"), bv = bu.createDocumentFragment();
            if (bv.createElement) {
                while (bw.length) {
        ...
        var aJ = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
            aa = / JQXLite\d+="(?:null|\d+)"/g, ah = /^\s+/,
            L = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, c = /<([\w:]+)/,
            v = /<tbody/i, P = /<|&#?\w+;/, W = /<(?:script|style|link)/i, I = /<(?:script|object|embed|option|style)/i,
            ac = new RegExp("<(?:" + aJ + ")[\\s/>]", "i"), R = /^(?:checkbox|radio)$/,
            o = /checked\s*(?:[^=]|=\s*.checked.)/i, bp = /\/(java|ecma)script/i,
            aG = /^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g, am = {
                ...
                area: [1, "<map>", "</map>"],
                _default: [0, "", ""]
            }, T = a(ak), bg = T.appendChild(ak.createElement("div"));
        ...
        C.buildFragment = function (bx, by, bv) {
            ...
            return {fragment: bw, cacheable: bu}
        };
        C.fragments = {};
        C.each({
            appendTo: "append",
        ...
        C.extend({
            clone: function (by, bA, bw) {
                ...
                var by, bw, bx, bC, bz = 0, bE = C.expando, bu = C.cache, bA = C.support.deleteExpando,
                    bB = C.event.special;
        ...
        (function () {
            ...
            C.uaMatch = function (bx) {
                ...
                return {browser: bw[1] || "", version: bw[2] || "0"}
            };
        ...
        var Q, bc, l, ad = /alpha\([^)]*\)/i, aj = /opacity=([^)]*)/, w = /^(top|right|bottom|left)$/,
            ai = /^(none|table(?!-c[ea]).+)/, av = /^margin/, i = new RegExp("^(" + aE + ")(.*)$", "i"),
            aV = new RegExp("^(" + aE + ")(?!px)[a-z%]+$", "i"), E = new RegExp("^([-+])=(" + aE + ")", "i"),
            J = {BODY: "block"}, ba = {position: "absolute", visibility: "hidden", display: "block"},
            aL = {letterSpacing: 0, fontWeight: 400}, D = ["Top", "Right", "Bottom", "Left"],
            O = ["Webkit", "O", "Moz", "ms"], be = C.fn.toggle;

        function a2(bx, bv) {
            if (bv in bx) {
                return bv
            }
            var by = bv.charAt(0).toUpperCase() + bv.slice(1), bu = bv, bw = O.length;
            while (bw--) {
                bv = O[bw] + by;
                if (bv in bx) {
                    return bv
        ...
        function aZ(bx, bv, bu, bz) {
            var bw = bu === (bz ? "border" : "content") ? 4 : bv === "width" ? 1 : 0, by = 0;
            for (; bw < 4; bw += 2) {
                if (bu === "margin") {
        ...
        function Y(bx, bv, bu) {
            var by = bv === "width" ? bx.offsetWidth : bx.offsetHeight, bw = true,
        ...
        function aN(bw) {
            ...
            var bu = C("<" + bw + ">").appendTo(ak.body), bv = bu.css("display");
            bu.remove();
            if (bv === "none" || bv === "") {
        ...
        if (!C.support.opacity) {
            C.cssHooks.opacity = {
                get: function (bv, bu) {
                    ...
                    var bx = by.style, bv = by.currentStyle,
        ...
        C(function () {
            if (!C.support.reliableMarginRight) {
                C.cssHooks.marginRight = {
                    get: function (bv, bu) {
                        return C.swap(bv, {display: "inline-block"}, function () {
                            if (bu) {
        ...
        C.each({margin: "", padding: "", border: "Width"}, function (bu, bv) {
            C.cssHooks[bu + bv] = {
                expand: function (by) {
            ...
            serialize: function () {
                ...
                return this.map(function () {
                    ...
                    return bw == null ? null : C.isArray(bw) ? C.map(bw, function (by, bx) {
                        return {name: bv.name, value: by.replace(br, "\r\n")}
        ...
        var a6, a1, ar = /^(?:toggle|show|hide)$/, aM = new RegExp("^(?:([-+])=|)(" + aE + ")([a-z%]*)$", "i"),
            a7 = /queueHooks$/, k = [bm], H = {
                "*": [function (bu, bB) {
                    var bx, bC, bD = this.createTween(bu, bB), by = aM.exec(bB), bz = bD.cur(), bv = +bz || 0, bw = 1,
                        bA = 20;
                    if (by) {
                        bx = +by[2];
        ...
        function Z(bv, bu) {
            C.each(bu, function (bA, by) {
                var bz = (H[bA] || []).concat(H["*"]), bw = 0, bx = bz.length;
                for (; bw < bx; bw++) {
        ...
        function bj(bw, bA, bD) {
            var bE, bz = 0, bu = 0, bv = k.length, bC = C.Deferred().always(function () {
                ...
                var bK = a6 || bl(), bH = Math.max(0, bx.startTime + bx.duration - bK), bF = bH / bx.duration || 0,
                    bJ = 1 - bF, bG = 0, bI = bx.tweens.length;
                for (; bG < bI; bG++) {
                    bx.tweens[bG].run(bJ)
                }
                ...
                elem: bw,
                props: C.extend({}, bA),
                opts: C.extend(true, {specialEasing: {}}, bD),
                ...
                stop: function (bG) {
                    var bF = 0, bH = bG ? bx.tweens.length : 0;
                    for (; bF < bH; bF++) {
                        bx.tweens[bF].run(1)
                    }
                    if (bG) {
            ...
            C.fx.timer(C.extend(by, {anim: bx, queue: bx.opts.queue, elem: bw}));
        ...
        function bm(by, bE, bu) {
            var bD, bw, bG, bx, bK, bA, bJ, bI, bH, bz = this, bv = by.style, bF = {}, bC = [],
        ...
        C.Tween = u;
        u.prototype = {
            constructor: u, init: function (bx, bv, bz, bu, by, bw) {
                this.elem = bx;
                this.prop = bz;
        ...
        C.fn.extend({
            fadeTo: function (bu, bx, bw, bv) {
                return this.filter(ap).css("opacity", 0).show().end().animate({opacity: bx}, bu, bw, bv)
            }, animate: function (bA, bx, bz, by) {
                var bw = C.isEmptyObject(bA), bu = C.speed(bx, bz, by), bv = function () {
                ...
                return this.each(function () {
                    var bB = true, by = bw != null && bw + "queueHooks", bA = C.timers, bz = C._data(this);
                    if (by) {
                        if (bz[by] && bz[by].stop) {
                            bx(bz[by])
                        }
        ...
        C.fn.offset = function (bE) {
            ...
            var bv, bA, bB, by, bC, bu, bx, bz = {top: 0, left: 0}, bw = this[0], bD = bw && bw.ownerDocument;
            if (!bD) {
                return
            }
            if ((bA = bD.body) === bw) {
            ...
            return {top: bz.top + bu - by, left: bz.left + bx - bC}
        };
        C.offset = {
            bodyOffset: function (bu) {
                var bw = bu.offsetTop, bv = bu.offsetLeft;
                ...
                var bz = C(bx), bv = bz.offset(), bu = C.css(bx, "top"), bE = C.css(bx, "left"),
                    bF = (bB === "absolute" || bB === "fixed") && C.inArray("auto", [bu, bE]) > -1, bD = {}, bC = {},
                    bw, by;
                if (bF) {
                    bC = bz.position();
                    bw = bC.top;
        ...
        C.fn.extend({
            isRendered: function () {
                ...
                by = {element: bw[0], offsetWidth: bw[0].offsetWidth, offsetHeight: bw[0].offsetHeight, callback: bx};
                try {
                ...
                var bw = this[0], bv = this.offsetParent(), bx = this.offset(),
                    bu = V.test(bv[0].nodeName) ? {top: 0, left: 0} : bv.offset();
                ...
                return {top: bx.top - bu.top, left: bx.left - bu.left}
        ...
        C.each({scrollLeft: "pageXOffset", scrollTop: "pageYOffset"}, function (bw, bv) {
            var bu = /Y/.test(bv);
            C.fn[bw] = function (bx) {
        ...
        C.each({Height: "height", Width: "width"}, function (bu, bv) {
            C.each({padding: "inner" + bu, content: bv, "": "outer" + bu}, function (bw, bx) {
...
(function (b) {
    ...
    if (!Object.keys) {
        Object.keys = (function () {
            var e = Object.prototype.hasOwnProperty, f = !({toString: null}).propertyIsEnumerable("toString"),
    ...
    b.jqx.applyWidget = function (d, f, l, m) {
        ...
        var k = {host: n, element: d, instance: m, initArgs: l};
        m.widgetName = f;
        b.data(d, f, k);
                ...
                switch (e) {
                    case"mousewheel":
                        if (b.jqx.browser.mozilla) {
                            h[0].addEventListener("DOMMouseScroll", f, b.jqx.isPassiveSupported() ? {passive: false} : false)
                        } else {
                            h[0].addEventListener("mousewheel", f, b.jqx.isPassiveSupported() ? {passive: false} : false)
                        }
                        continue;
                    case"mousemove":
                        if (!g) {
    ...
    b.extend(b.jqx.utilities, {
        scrollBarSize: 13, touchScrollBarSize: 8, scrollBarButtonsVisibility: "visible", createId: function () {
            var c = function () {
                return (((1 + Math.random()) * 65536) | 0).toString(16).substring(1)
            };
            ...
            var j = f[0].className.split(" "), c = [], k = [], e = f.children();
            ...
            if (p) {
                if (m === -1) {
                    this.resizeHandlers.push({id: h[0].id, widget: h, callback: t, data: f})
                }
            }
            try {
                ...
                if (k) {
                    ...
                    if (!l.observer) {
                        ...
                        l.observer.observe(document.body, {attributes: true, childList: true, characterData: true})
                    }
                }
            } catch (r) {
            }
            ...
            var c = /^[\],:{}\s]*$/, g = /(?:^|:|,)(?:\s*\[)+/g, d = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
            ...
            try {
                return b.access(d, function (s) {
                    ...
                    var r = /<(?:script|style|link)/i,
                        ...
                        h = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, p = /<([\w:]+)/,
                        g = /<(?:script|object|embed|option|style)/i, k = new RegExp("<(?:" + n + ")[\\s/>]", "i"),
                        q = /^\s+/, t = {
                            option: [1, "<select multiple='multiple'>", "</select>"],
                            legend: [1, "<fieldset>", "</fieldset>"],
                            thead: [1, "<table>", "</table>"],
            ...
            var e = {browser: c[1] || "", version: c[2] || "0"};
    ...
    b.jqx.isHidden = function (d) {
        ...
        var c = d[0].offsetWidth, e = d[0].offsetHeight;
        if (c === 0 || e === 0) {
            return true
        } else {
            return false
    ...
    b.extend(b.jqx.mobile, {
        _touchListener: function (i, g) {
            ...
            var h = {mousedown: "touchstart", mouseup: "touchend", mousemove: "touchmove"};
            var f = c(h[i.type], i);
            ...
            var e = {mousedown: "touchstart", mouseup: "touchend", mousemove: "touchmove"};
            var c = this;
            ...
            var s = function (am) {
                ...
                if (k) {
                    ...
                    var an = G.getTouches(am)[0], al = G.getRootNode(an.target);
            ...
            if (this.simulatetouches) {
                ...
                var K = function (al) {
                    ...
                    G.scrolling[H] = false;
                    var an = G.getTouches(al)[0], am = G.getRootNode(an.target);
        ...
        cookie: function (f, g, d) {
            if (arguments.length > 1 && String(g) !== "[object Object]") {
                ...
                if (typeof d.expires === "number") {
                    var i = d.expires, e = d.expires = new Date();
...
(function (b) {
    ...
    b.fn.coord = function (n) {
        var e, j, i = {top: 0, left: 0}, f = this[0], l = f && f.ownerDocument;
        if (!l) {
            return
        }
        e = l.documentElement;
        ...
        e.on("mousedown.ripple", function (i) {
            ...
            setTimeout(function () {
                ...
                if (o === "checkbox" || o === "radiobutton") {
                    ...
                    r.css({top: t + "px", left: q + "px"}).addClass("animate");
